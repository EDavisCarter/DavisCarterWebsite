...
![**1. Animals were exposed in 200mL tubes containing 9mL of H2O and 1mL of the assigned *Bsal* dose.**](https://github.com/EDavisCarter/DavisCarterWebsite/blob/master/Inoculation.png?raw=true)

![**2. Animals were held in the inoculation tubes for 24hrs. **](https://github.com/EDavisCarter/DavisCarterWebsite/blob/master/ExposureTubes.jpg?raw=true)

![**3. Following exposure animals were placed in individuals containers and held at a constant temperature inside environmental chambers. **](https://github.com/EDavisCarter/DavisCarterWebsite/blob/master/EnvironmentalChamber.jpg?raw=true)
